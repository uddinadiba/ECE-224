...
module QD1_mm_interconnect_0 (
	...
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> spi_master_s1_agent:cp_valid
	wire  [104:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> spi_master_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // spi_master_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [17:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> spi_master_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> spi_master_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> spi_master_s1_agent:cp_endofpacket
	...
	wire  [104:0] cmd_mux_017_src_data;                                                               // cmd_mux_017:src_data -> timer_0_s1_agent:cp_data
	wire          cmd_mux_017_src_ready;                                                              // timer_0_s1_agent:cp_ready -> cmd_mux_017:src_ready
	wire   [17:0] cmd_mux_017_src_channel;                                                            // cmd_mux_017:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire          spi_master_s1_agent_rp_valid;                                                       // spi_master_s1_agent:rp_valid -> router_016:sink_valid
	wire  [104:0] spi_master_s1_agent_rp_data;                                                        // spi_master_s1_agent:rp_data -> router_016:sink_data
	wire          spi_master_s1_agent_rp_ready;                                                       // router_016:sink_ready -> spi_master_s1_agent:rp_ready
	wire          spi_master_s1_agent_rp_startofpacket;                                               // spi_master_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          spi_master_s1_agent_rp_endofpacket;                                                 // spi_master_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire  [104:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_019:sink_data
	...
	wire  [104:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_017:sink0_data
	...
	wire  [104:0] rsp_demux_017_src0_data;                                                            // rsp_demux_017:src0_data -> rsp_mux_001:sink2_data
	...
	wire          spi_master_s1_agent_rdata_fifo_src_valid;                                           // spi_master_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] spi_master_s1_agent_rdata_fifo_src_data;                                            // spi_master_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          spi_master_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_014:in_0_ready -> spi_master_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> spi_master_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> spi_master_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // spi_master_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> spi_master_s1_agent:rdata_fifo_sink_error
	...
	QD1_mm_interconnect_0_router_019 router_019 (
